...
CDFVI welcomes all interested developers, regardless of DESC membership or LSST data rights.

=========================
Contributing to ``CDFVI``
=========================

If you're interested in contributing to `CDFVI`, but don't know where to start, take a look 
at the
`list of issues <https://github.com/KIPAC/CDFVI/issues>`_.
Or, `create a new issue <https://github.com/KIPAC/CDFVI/issues/new>`_ to 
suggest a change.
...
The ``CDFVI`` repository use an issue-branch-review workflow, 
...
When you identify something that should be done, `make an issue <https://github.com/KIPAC/CDFVI/issues/new>`_
for it.
...
Python classes should use the CapWords convention.
